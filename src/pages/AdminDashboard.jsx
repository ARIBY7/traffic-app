...
function QuickCard({ label, desc, icon, color, onClick }) {
  ...
  return (
    <div onClick={onClick} onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)} style={{
      ...
      <div style={{ width: 46, height: 46, borderRadius: 12, flexShrink: 0, background: color + "18", border: `1px solid ${color}35`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22 }}>
        {icon}
      </div>
      <div>
...
export default function AdminDashboard() {
  ...
  const [showLogout, setShowLogout]   = useState(false);  // ← Logout modal
    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: COLORS.bg.main, color: COLORS.text.primary, minHeight: "100vh" }}>
      ...
      <div style={{ marginLeft: 220, padding: "2.5rem", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ marginBottom: "2.5rem" }}>
          <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: "1.1rem", fontWeight: 700, color: COLORS.text.primary, marginBottom: "1rem" }}>
            Quick Access
          </h2>
        ...
        <div>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "1rem" }}>
            <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: "1.1rem", fontWeight: 700, color: COLORS.text.primary }}>
              Recent Sensors
            </h2>
              ...
              recentSensors.map((s, i) => {
                ...
                return (
                  <div key={s.id} style={{ display: "grid", gridTemplateColumns: "60px 1fr 1fr 120px", padding: "0.9rem 1.4rem", borderBottom: i === recentSensors.length - 1 ? "none" : "1px solid rgba(127, 119, 221, 0.06)", alignItems: "center" }}>
                    ...
                    <span style={{ fontSize: "0.85rem", color: COLORS.text.muted }}>{s.zone}</span>
