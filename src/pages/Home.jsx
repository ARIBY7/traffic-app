  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        fontSize: 22, marginBottom: "1.1rem",
      }}>{icon}</div>
  ...
  return (
    <div style={{ fontFamily: "'DM Sans',sans-serif", background: C.bg, color: "#f0f0f0", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <header style={{
        ...
        <div
          onClick={() => navigate("/")}
          style={{ display: "flex", alignItems: "center", gap: 10, fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: "1.2rem", color: "#fff", cursor: "pointer" }}
        >
          <div style={{
        ...
        <nav style={{ display: "flex", alignItems: "center", gap: "2rem" }}>
          ...
          <button
            ...
            style={{
              ...
              padding: "0.48rem 1.3rem", borderRadius: 8,
      ...
      <section style={{ position: "relative", maxWidth: 860, margin: "0 auto", padding: "7rem 3rem 5rem", textAlign: "center" }}>
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <div style={{
            ...
            background: C.p900 + "cc", border: `1px solid ${C.p600}66`,
            borderRadius: 100, padding: "0.38rem 1rem 0.38rem 0.55rem",
            marginBottom: "2.2rem",
          }}>
            <div style={{
              width: 8, height: 8, borderRadius: "50%",
              background: C.t400,
              transform: `scale(${pulse ? 1 : 0.7})`,
              transition: "transform 0.5s ease",
              boxShadow: `0 0 6px ${C.t400}`,
            }} />
            <span style={{ fontSize: "0.78rem", color: C.p200, fontWeight: 500, letterSpacing: "0.06em" }}>
          ...
          <h1 style={{
            ...
            <span style={{
              background: `linear-gradient(135deg, ${C.p200}, ${C.p400}, ${C.t200})`,
              WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text",
            }}>manage urban traffic</span>
          </h1>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "1rem", flexWrap: "wrap" }}>
            <button
              onMouseEnter={() => setBtnHov("p")}
              onMouseLeave={() => setBtnHov(null)}
              onClick={() => navigate("/login")}
              style={{
                background: `linear-gradient(135deg, ${C.p400}, ${C.p600})`,
                color: "#fff", border: "none",
                padding: "0.9rem 2.4rem", borderRadius: 10,
                fontSize: "0.95rem", fontWeight: 600,
                cursor: "pointer", fontFamily: "inherit",
                boxShadow: btnHov === "p" ? `0 0 32px ${C.p400}55` : "none",
                transform: btnHov === "p" ? "translateY(-2px)" : "none",
                transition: "all 0.2s",
              }}
            >Get Started →</button>

            <button
              onMouseEnter={() => setBtnHov("g")}
              onMouseLeave={() => setBtnHov(null)}
              onClick={() => document.getElementById("features")?.scrollIntoView({ behavior: "smooth" })}
              style={{
                background: btnHov === "g" ? "rgba(255,255,255,0.06)" : "transparent",
                color: btnHov === "g" ? "#fff" : "#7C7A99",
      ...
      <section id="features" style={{ maxWidth: 860, margin: "0 auto 7rem", padding: "0 3rem" }}>
        <div style={{ textAlign: "center", marginBottom: "3rem" }}>
          <h2 style={{ fontFamily: "'Syne',sans-serif", fontSize: "2rem", fontWeight: 800, color: "#fff", letterSpacing: "-0.5px", marginBottom: "0.7rem" }}>
            Everything you need
          </h2>
      ...
      <section id="about" style={{ maxWidth: 860, margin: "0 auto 7rem", padding: "0 3rem" }}>
        <div style={{
          background: `linear-gradient(135deg, ${C.p900}bb, ${C.bg2})`,
          border: `1px solid ${C.p600}44`,
          borderRadius: 20, padding: "3.5rem",
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <button
              ...
              style={{
                background: `linear-gradient(135deg, ${C.p400}, ${C.p600})`,
                color: "#fff", border: "none",
                padding: "0.9rem 2.6rem", borderRadius: 10,
                fontSize: "0.95rem", fontWeight: 600,
                cursor: "pointer", fontFamily: "inherit",
                transition: "all 0.2s",
              }}
      ...
      <footer style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span style={{ fontFamily: "'Syne',sans-serif", fontWeight: 700, color: "#fff", fontSize: "0.9rem" }}>TrafficIQ</span>
        </div>
